...
$ecms_config['db']['dbname']='ecms75';	//数据库名
...
$ecms_config['cks']['ckrndthree']='www.phome.net';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='www.phome.net';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='www.phome.net';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
